...
function this.get_config()
    ...
    children.line1 = {
        ...
        size_y = { enabled = false, value = 1 },
        offset = { enabled = false, x = 0, y = 0 },
        var0 = { enabled = false, key = "var0", name_key = "material_size_x_scale", value = 1 },
        var1 = { enabled = false, key = "var1", name_key = "material_size_y_scale", value = 1 },
        var2 = { enabled = false, key = "var2", name_key = "material_anim_speed_scale", value = 1 },
        var3 = { enabled = false, key = "var3", name_key = "material_level_max_scale", value = 1 },
