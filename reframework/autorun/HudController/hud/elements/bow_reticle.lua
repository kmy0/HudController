...
function this:new(args)
    ...
    o.children.reticle_main = hud_child:new(args.children.reticle_main, o, function(_, _, _, ctrl)
    ...
    o.children.lockon = hud_child:new(args.children.lockon, o, function(_, _, _, ctrl)
    ...
    o.children.out_of_range = hud_child:new(args.children.out_of_range, o, function(_, _, _, ctrl)
