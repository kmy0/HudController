...
function this.get_config()
    ...
    children.line1 = {
        ...
        var0 = { enabled = false, key = "var0", name_key = "material_width_scale", value = 1 },
        var1 = { enabled = false, key = "var1", name_key = "material_anim_speed_scale", value = 1 },
        var2 = { enabled = false, key = "var2", name_key = "material_side_mag_scale", value = 1 },
