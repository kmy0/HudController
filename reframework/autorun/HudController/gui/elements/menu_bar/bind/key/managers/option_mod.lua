---@class GuiOptionModKeyManager : GuiKeyManagerBase
...
---@return GuiOptionModKeyManager
function this:new(manager, config_key)
    local o = base.new(self, manager, config_key)
    setmetatable(o, self)
    ---@cast o GuiOptionModKeyManager
    return o
end

---@return boolean
function this:draw_target()
    return set:combo_filter("##bind_target_combo", "__temp.combo_target", cd.combo.option_mod_bind)
end

---@return boolean
function this:draw_option()
    return util_bind.draw_option(function()
        local key = cd.combo.option_mod_bind:get_key(config:get("__temp.combo_target"))
...
function this:make_base_bind(set_default)
    ...
    self.base_bind = {
        ...
        bound_value = {
            key = cd.combo.option_mod_bind:get_key(config:get("__temp.combo_target")),
