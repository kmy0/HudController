...
local function to_0_3_0_config_keys(config)
    config.mod.enable_condition_binds = config.mod.enable_condition_binds
    config.mod.disable_condition_binds_held = config.mod.disable_condition_binds_held
    config.mod.disable_condition_binds_timed = config.mod.disable_condition_binds_timed
    config.mod.disable_condition_binds_time = config.mod.disable_condition_binds_time
end
