...
return {
    ...
    hud_element = {
        ...
        entry = {
            ...
            box_hide_contains = "Hide Contains",
            box_hide_not_contains = "Hide Not Contains",
            tooltip_notice_system_pattern = "Hide elements with matching messages\nThe mod expects lua patterns: https://www.lua.org/manual/5.4/manual.html#6.4.1\nYou can use multiple patterns by splitting them with '|'\nWorks only for messages with an ID\nCase-insensitive",
            category_notice_system_pattern = "System Message Pattern",
