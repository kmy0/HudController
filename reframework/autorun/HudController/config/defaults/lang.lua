...
return {
    ...
    debug = {
        ...
        combo_elem_cache_values = {
            DISABLED = "Disabled",
            FRAME = "Refresh every n frames + n jitter",
            ONCE = "Cache once",
        },
        slider_frame = "Frames",
        slider_jitter = "Jitter",
        combo_elem_cache = "Cache",
    },
    selector = {
        name = "Config Manager",
        ...
        tooltip_restore = "Make backup file selectable in the Config File combo box",
        button_export = "Export",
        button_import = "Import",
        tooltip_button_import = "Create new file and import config json string from clipboard",
        tooltip_button_export = "Export config json string to clipboard",
        text_wait_reset = "Waiting for Script Reset...",
    },
    sorter = {
        name = "Profile Sorter",
        button_apply = "Apply",
    ...
    canvas = {
        ...
        slider_anchor_offset_x = "Anchor Offset X",
        slider_anchor_offset_y = "Anchor Offset Y",
    ...
    menu = {
        config = {
            ...
            disable_condition_binds_timed = "Disable Condition Binds Timed",
            ...
            hide_disabled_element_profiles = "Hide Disabled",
        },
        language = {
            name = "Language",
            fallback = "Fallback",
        ...
        bind = {
            ...
            condition = {
                condition_minimap_state_values = {
                    DEFAULT = "None",
                ...
                condition_sharpness_color_values = {
                    RED = "Red",
                    ORANGE = "Orange",
                    YELLOW = "Yellow",
                    GREEN = "Green",
                ...
                button_add_new_condition = "Add Rule",
                button_remove = "Remove",
                button_add = "Add",
                button_duplicate = "Duplicate",
                name = "Condition",
                combo_profile = "Profile",
                condition_health_changed = "Health Changed",
                condition_ammo_changed = "Ammo Changed",
                condition_stamina_changed = "Stamina Changed",
                condition_sharpness_changed = "Sharpness Changed",
                condition_sharpness_color = "Sharpness Color",
                condition_riding = "Riding",
                condition_village = "Village",
                condition_minimap_state = "Minimap State",
                condition_combat_state = "Combat State",
                condition_opt_in_combat = "In Combat",
                condition_opt_out_of_combat = "Out of Combat",
                ...
                menubar_mod_options = "Mod Options",
                category_hud_options = "HUD OPTIONS",
                category_mod_options = "MOD OPTIONS",
                category_game_options = "GAME OPTIONS",
                category_user_options = "USER OPTIONS",
                category_element_profile = "ELEMENT PROFILES",
                category_hud = "HUD",
                menubar_game_options = "Game Options",
                menubar_user_options = "User Options",
                button_clear = "Clear",
        ...
        user = {
            ...
            options = {
                ...
                placeholder = {
                    ...
                    ["<ICON PAD PL_AIM>"] = "Aim/Focus Mode",
                    ["<ICON PAD PL_DUMMY_MOVE>"] = "LS",
                    ["<ICON PAD UI_DUMMY_ICON_LB>"] = "LB",
                    ["<ICON PAD UI_DUMMY_ICON_RB>"] = "RB",
                    ["<ICON PAD UI_CHAT_LOG_OPEN>"] = "START",
                    ["<ICON PL_AIM>"] = "RBM",
                    ["<ICON PL_ITEM_SLIDER_OPEN>"] = "CTRL",
                    ["<PLATMSG MsgGUI030100_04_44>"] = "Controller Vibration Settings",
                    ["<PLATMSG MsgGUI030100_02_28>"] = "Gyro Camera Controls",
                    ["<PLATMSG MsgGUI030100_01_42>"] = "Confirm Button",
                    ["<PLATMSG MsgGUI030100_03_13>"] = "Screen Brightness",
                    ["<PLATMSG MsgGUI030100_01_45>"] = "Button Configurations",
                    ["<ICON PAD UI_DUMMY_ICON_LT>"] = "LT",
                    ["<ICON PAD UI_DUMMY_ICON_RT>"] = "RT",
                    ["<ICON PAD PL_DASH_TOGGLE>"] = "LS",
                    ["<ICON PAD PL_DASH>"] = "RB",
                    ["<ICON PAD PL_POP_CHANGE_SELECT>"] = "LT",
                    ["<ICON PAD UI_DUMMY_ICON_RDOWN>"] = "RDOWN",
                    ["<ICON PAD UI_DUMMY_ICON_RRIGHT>"] = "RRIGHT",
                    ["<PLATMSG MsgGUI030100_04_44_00>"] = "On",
    ...
    hud = {
        ...
        button_rename = "Rename",
        button_import = "Import",
        text_add_elements = "Add Elements...",
        button_import_tooltip = "Create new profile and import hud json string from clipboard",
        button_export = "Export",
        ...
        box_fade_opacity = "Fade Opacity Changes Only",
        tooltip_fade_opacity = "Only elements with different opacity settings between profiles are faded. Other elements switch immediately",
        ...
        tooltip_hide_monster_icon = "Hide Icons - Monster icons are hidden unless paintballed\nHide Lock Target - Target Lock is hidden and tracking is disabled unless monster is paintballed",
        ...
        hide_npc = {
            ...
            NO_FACILITY = "Hide Non Facility",
            NO_TALK = "Hide Non Interactable",
        },
        em_scar = {
            DISABLED = "Do Not Change",
            HIDE = "Hide Wounds",
            SHOW = "Always Display Wounds",
            DISABLE = "Disable Wounds",
        },
        em_icon = {
            DISABLED = "Do Not Change",
            HIDE_ICON = "Hide",
            HIDE_ICON_TARGET = "Hide Icons & Lock Target",
        },
        slider_em_scar = "Wounds",
        ...
        drag_hide_porter = "Seikret Hide Delay",
        drag_hide_handler = "Handler Hide Delay",
        tooltip_choice_disabled = "Disabled while Condition Binds are active",
        slider_em_icon = "Icons",
        slider_hide_npc = "Hide Npc",
        category_user_options = "User Options",
    },
    hud_profile = {
        header_hud_profile = "Element Profiles",
        text_default_profile = "Base",
        button_rename = "Rename",
        button_add = "Add",
        button_import = "Import",
        button_export = "Export",
        button_sort = "Sort",
        tooltip_button_sort = "Sort profiles alphabetically",
        tooltip_button_import = "Import element json string from clipboard",
    ...
    hud_element = {
        ...
        entry = {
            ...
            box_cache_sfx = "Log Sfx",
            box_cache_subtitles = "Log Subtitles",
            category_mute_sfx = "Mute Sfx",
            combo_subtitles = "Subtitles",
            combo_npc = "Npc",
            combo_dialogue_type = "Type",
            combo_dialogue_actor_type = "Actor Type",
            button_mute = "Mute",
            ...
            combo_notice_system = "System Message",
            combo_notice_lobby = "Lobby Message",
            combo_notice_lobby_target = "Lobby Message Target",
            combo_notice_auto_id = "Auto Shoutouts",
            combo_notice_enemy = "Enemy Message Type",
            combo_tool_enemy = "Enemy Message Type",
            combo_notice_camp = "Camp Message Type",
            combo_object_category = "Object Category",
            category_mantle_behavior = "Mantle Behavior",
            combo_nameplate_type = "Nameplate Type",
            ...
            combo_npc_type = "NPC Type",
            combo_gossip_type = "Gossip Type",
            combo_panel_type = "Panel Type",
            combo_enemy_type = "Enemy Type",
            ...
            box_enable_map_fov = "Map Scale",
            box_enable_icon_scale = "Icon Scale",
            ...
            box_enable_scale = "Scale",
            box_enable_offset = "Offset",
            box_enable_rotation = "Rotation",
            box_enable_opacity = "Opacity",
            box_enable_size_x = "Size X",
            box_enable_size_y = "Size Y",
            box_enable_segment = "Layer",
            box_enable_offset_x = "Offset X",
            box_enable_material_width_scale = "Width Scale",
            box_enable_material_anim_speed_scale = "Animation Speed Scale",
            box_enable_material_size_x_scale = "Size X Scale",
            box_enable_material_size_y_scale = "Size Y Scale",
            box_enable_material_side_mag_scale = "Side Position Scale",
            box_enable_material_level_max_scale = "Level Max Scale",
            box_enable_scale9_alpha_channel = "Enable Alpha Channel",
            box_enable_num_offset_x = "Num Offset X",
            ...
            box_enable_font_size = "Font Size",
            box_enable_page_alignment = "Alignment",
            box_enable_clock_offset_x = "Clock Offset X",
            tooltip_itembar_move_next = "Move to the next item if slot is empty after use",
            slider_npc_draw_distance = "NPC Draw Distance",
            slider_pet_draw_distance = "Pet Draw Distance",
            slider_pl_draw_distance = "Player Draw Distance",
            ...
            combo_notice_system_id = "System Message ID",
            button_hide = "Hide",
            ...
            box_disable_fade_opacity = "Use Full Fade",
