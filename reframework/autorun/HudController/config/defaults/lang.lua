...
return {
    ...
    hud = {
        ...
        box_hide_monster_icon = "Hide",
        box_hide_lock_target = "Hide Icons & Lock Target",
    ...
    hud_profile = {
        ...
        button_rename = "Rename",
        button_add = "Add",
        button_set_default = "Set Default",
        button_import = "Import",
        button_export = "Export",
        button_sort = "Sort",
        ...
        tooltip_button_set_default = "Set this as the default profile for this element.\nThis profile is used when this Hud becomes active or when the selected profile is disabled",
